...
# The nested-subshell compatibility case. Verified real finding
...
# subshell's own cd. fm_backend_cmux_current_path's active pwd-probe must keep
# reporting the live shell path, not just a plain cd in the top-level shell.
