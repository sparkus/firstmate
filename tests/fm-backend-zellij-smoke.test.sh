...
# The nested-subshell compatibility case. Verified real bug: zellij's
# `pane_cwd` JSON field stays frozen
...
# pwd-probe (docs/zellij-backend.md) must keep reporting the live shell path,
